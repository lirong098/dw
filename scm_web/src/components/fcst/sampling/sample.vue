    ...
    <div class="test_main">
      <el-tabs v-model="TABSValue" type="card" @tab-remove="removeTab">
        <el-tab-pane  v-for="(item, index) in TABS"
          ...
          <template v-if="item.name > 100 && item.name < 200">
            <sample-preview  :rowId="rowId"
                             :TABS="TABS"
                             :TABSValue="TABSValue"
                             :tabIndex="tabIndex"
                             :tableName="tableName"
...
<script>
  //公共组件
  import sampleInfo from './sample_info.vue';
  import sampleEdit from './sample_edit.vue';

  import samplePreview from './sample_preview.vue';
