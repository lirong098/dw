          ...
          <el-card class="divCard">
            <el-col class="detailMessage">
              <el-form class="detaMessageForm" :model="detaMessageForm" ref="detaMessageForm">
                <el-col :span="12">
                  <el-form-item label="实单单号：">
                    <el-input class="nochange" v-text="detaMessageForm.fcst_pr.fcst_pr_no" v-show="!changeStatus"></el-input>
                    <el-input class="truechange" v-model="detaMessageForm.fcst_pr.fcst_pr_no" v-show="changeStatus" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="实单交期：">
                    <el-input class="nochange" v-text="detaMessageForm.fcst_pr.delivery_date" v-show="!changeStatus"></el-input>
                    <el-date-picker v-model="detaMessageForm.fcst_pr.delivery_date" type="date" placeholder="选择日期"
                                    :picker-options="pickerOptions" @change="changeDeliveryDate"
                                    v-show="changeStatus">
                    </el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="单据日期：">
                    <el-input class="nochange" v-text="detaMessageForm.fcst_pr.deal_date ?detaMessageForm.fcst_pr.deal_date:'2222'" v-show="!changeStatus"></el-input>
                    <el-date-picker v-model="detaMessageForm.fcst_pr.deal_date" type="date" placeholder="选择日期"
                                    :picker-options="pickerOptions" @change="changeDealDate"
                                    v-show="changeStatus">
                    </el-date-picker>
                  </el-form-item>
                </el-col>
            ...
            <el-col class="composition">
              <el-table ref="multipleTable"
                ...
                <el-table-column label="款号" show-overflow-tooltip>
                  <template scope="scope">
                    <el-input v-text="scope.row.item.model.extend ? scope.row.item.model.extend.iman_code : ''">
                    </el-input>
                  </template>
                </el-table-column>
                <el-table-column label="颜色" show-overflow-tooltip>
                  <template scope="scope">
                    <el-input v-text="scope.row.item.model.spec ? scope.row.item.model.spec.color : ''">
                    </el-input>
                  </template>
                </el-table-column>
    ...
    methods: {
      ...
      saveBtnConfirm(addFun) {
        ...
        requst.requst(this, url, function (that, objRes) {
          console.log("fanhui",objRes.data);
