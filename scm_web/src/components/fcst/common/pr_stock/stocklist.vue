      ...
      <el-tabs v-model="TABSValue" type="card" @tab-remove="removeTab">
        <el-tab-pane  v-for="(item, index) in TABS"
          ...
          <template v-else-if="item.tabName">
            <bom_detailed v-if="item.tabName == 'bominfo'" :rowMessage="item" :TABSValue="TABSValue" :tabIndex="tabIndex" @CloseTab="parentCloseTab" @changeTabMethod="changetab"></bom_detailed>
            <stock_detailed v-if="item.tabName == 'stockmanagement'"
                            ...
                            :TABS="TABS" :TABSValue="TABSValue" :tabIndex="tabIndex" @CloseTab="parentCloseTab" @changeTabMethod="changetab"></stock_detailed>
          </template>
          <template v-else>
...
<script>
  ...
  import stock_detailed from "../../../mrp/common/material_stock/material_stock_info.vue";
  import bom_detailed from '../../../mrp/tailoringbom/tailoring_bom_detailed.vue';
  //公共文件
