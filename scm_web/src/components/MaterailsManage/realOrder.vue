        ...
        <el-tabs v-model="currentTab" type="card"
          ...
          >
            <div v-if="item.name == 'main'">
              <realOrderMain @changeTabs="changeTabs"
                                  :isFresh="isFresh"
                                  @cancelTab="cancelTab"></realOrderMain>
            </div>
            <div
              v-else-if="addOrderData[item.index] && item.name == 'addOrder_'+addOrderData[item.index].tabIndex">
              <realOrderEdit @changeTabs="changeTabs"
                                  @cancelTab="cancelTab"
                                  @isUpdate="isUpdate"
                                  ...
                                  :modelData="modelData"
                                  :optType="item.type"></realOrderEdit>
            </div>
            <div
...
<script>
  import realOrderMain from '../../components/MaterailsManage/realOrder_main.vue';
  import realOrderEdit from '../../components/MaterailsManage/realOrder_edit.vue';
