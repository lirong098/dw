...
//        let nameType = 'xls';
        console.log(name,'name')
        console.log(name !== 'xls' || name !== 'xlsx')
...
//        }
        ...
        let Url = api + '/api/mat_models/mrp_model_bom/' + fileName;
...
//        let id = this.importType === 2 ? 26 : 27;
        ...
        let url = this.$store.state.NEW_API + '/api/newfcst/fcst_imports/?page=' + page + '&pagesize=' + qty + '&fcst_import_type__meta_id=77';
