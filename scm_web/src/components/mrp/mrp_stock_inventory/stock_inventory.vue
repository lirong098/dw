    ...
    <div class="test_main">
      <el-tabs v-model="TABSValue" type="card" @tab-remove="removeTab">
        <el-tab-pane v-for="(item, index) in TABS"
          ...
          <!--<template v-else>-->
          <!--<cuctomerDetailed :rowMessage="item.rowId"-->
          <!--:TABS="TABS"-->
          <!--:TABSValue="TABSValue"-->
          <!--:tabIndex="tabIndex"-->
          <!--@CloseTab="parentCloseTab"-->
...
<script>
  import stockInventory from './stock_inventory_info.vue'
  //  import cuctomerDetailed from './customer_detailed.vue'
  export default {
    name: 'test-manage',
    components: {
      stockInventory,
